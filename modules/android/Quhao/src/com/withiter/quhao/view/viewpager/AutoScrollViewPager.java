package com.withiter.quhao.view.viewpager;
 ...
 */
public class AutoScrollViewPager extends ViewPager implements OnGestureListener{
    ...
    public AutoScrollViewPager(Context paramContext) {
        super(paramContext);
        GestureDetector detector = new GestureDetector(paramContext, this);
		mDetector = detector;
        init();
    }
