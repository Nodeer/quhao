...
@SuppressLint("NewApi")
public abstract class QuhaoBaseFragmentActivity extends QuhaoActivity implements OnClickListener, OnTouchListener {

	private final String TAG = QuhaoBaseFragmentActivity.class.getName();
