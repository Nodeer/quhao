	...
	private Handler merchantUpdateHandler = new Handler() 
	{
		...
		public void handleMessage(Message msg)
		{
			if(msg.what == 200)
			{
		    	...
		    	{
		    		MerchantDetailActivity.this.merchantName.setText(MerchantDetailActivity.this.merchant.name);
		    		//MerchantDetailActivity.this.merchantImg = (ImageView) info.findViewById(R.id.merchantImg);
		    		MerchantDetailActivity.this.merchantAddress.setText(MerchantDetailActivity.this.merchant.address);
		    		MerchantDetailActivity.this.merchantPhone.setText(MerchantDetailActivity.this.merchant.phone);
		    		MerchantDetailActivity.this.merchantTags.setText(MerchantDetailActivity.this.merchant.tags);
		    		MerchantDetailActivity.this.merchantAverageCost.setText(MerchantDetailActivity.this.merchant.averageCost);
		    		MerchantDetailActivity.this.xingjiabi.setText(String.valueOf(MerchantDetailActivity.this.merchant.xingjiabi));
		    		MerchantDetailActivity.this.kouwei.setText(String.valueOf(MerchantDetailActivity.this.merchant.kouwei));
		    		MerchantDetailActivity.this.fuwu.setText(String.valueOf(MerchantDetailActivity.this.merchant.fuwu));
		    		MerchantDetailActivity.this.huanjing.setText(String.valueOf(MerchantDetailActivity.this.merchant.huanjing));
		    	}
	...
	private Runnable merchantDetailRunnable = new Runnable()
	{
		...
		public void run()
		{
			try
			{
				...
				HttpGet request = new HttpGet(QuhaoConstant.HTTP_URL + "merchant?id=" + MerchantDetailActivity.this.merchantId);
