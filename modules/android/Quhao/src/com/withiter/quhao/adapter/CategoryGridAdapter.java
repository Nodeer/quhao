...
public class CategoryGridAdapter extends BaseAdapter{
	...
	public CategoryGridAdapter(List<? extends Object> list,GridView grid,Context context)
	{
		this.list = list;
		this.grid = grid;
	...
	public View getView(int position, View convertView, ViewGroup parent)
	{
		...
		synchronized (item)
		{
			...
			if(null == convertView)
			{
				...
				holder.countView = (TextView) convertView.findViewById(R.id.category_item_count);
			}
