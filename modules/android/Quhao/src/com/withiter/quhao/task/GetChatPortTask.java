 ...
 *
 */
public class GetChatPortTask extends BaseTask {
...
//	private HashMap<String, String> mParams;
	 ...
	 * @param token
	 */
	public GetChatPortTask(int preDialogMessage,Context context,String url) {
...
//		System.out.println("Token"+token+"***************userid"+userid);
	...
	private static JsonPack getJsonPack(String responseString)
		...
		if (!StringUtils.isNull(responseString) && !"[]".equals(responseString) && !"null".equals(responseString) && !"false".equals(responseString)) {
