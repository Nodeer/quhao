 ...
 *
 */
public class NearbySearchMerchantTask extends BaseTask {
...
//	private HashMap<String, String> mParams;
	 ...
	 * @param token
	 */
	public NearbySearchMerchantTask(int preDialogMessage,Context context,String url) {
...
//		System.out.println("Token"+token+"***************userid"+userid);
	...
	private static JsonPack getJsonPack(String responseString)
		...
		if (!TextUtils.isEmpty(responseString) && !"[]".equals(responseString)) {
