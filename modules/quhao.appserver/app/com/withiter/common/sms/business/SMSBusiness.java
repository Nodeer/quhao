...
public class SMSBusiness {
	...
	public static int sendAuthCodeForSignup(String mobileNumber) throws HttpException, IOException {
		...
		PostMethod post = new PostMethod("http://utf8.sms.webchinese.cn");
		post.addRequestHeader("Content-Type", "application/x-www-form-urlencoded;charset=utf8");// 在头文件中设置转码
		NameValuePair[] data = { new NameValuePair("Uid", UID), new NameValuePair("Key", KEY), new NameValuePair("smsMob", mobileNumber), new NameValuePair("smsText", message) };
		post.setRequestBody(data);
		client.executeMethod(post);
		int statusCode = post.getStatusCode();
		post.releaseConnection();
	...
	public static void main(String[] args) throws HttpException, IOException {
		...
		NameValuePair[] data = { new NameValuePair("Uid", "withiter"), new NameValuePair("Key", "65a4d62f45a07fd1d206"), new NameValuePair("smsMob", "18817261072"),
