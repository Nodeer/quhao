...
public class I18nKeys {
	...
	public final static String	V_ALREADY_EXISTS					= "validation.alreadyexist";
	public static final String	V_REPEAT_PASSWORD_DOES_NOT_EQUAL	= "validation.repeat_password_does_not_equal";
	public static final String	V_INVALID_CAPTCHA					= "validation.captcha";
	public static final String	V_LOGIN_FAILED                      = "validation.login_failed";
