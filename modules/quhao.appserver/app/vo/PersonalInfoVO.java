...
public class PersonalInfoVO {
	...
	public void build(LoginVO loginVO, List<ReservationVO> currentReservationVOs, List<MerchantVO> currentMerchantVOs, List<ReservationVO> histroytReservationVOs, List<MerchantVO> histroyMerchantVOs) {
